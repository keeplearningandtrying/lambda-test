...
public class Simpson2 {
	/**
	 * Approximates the definite integral using Simpson's Rule. The function should
	 * be continuous in the range [a, b]. The specified number of subintervals
	 * should be even, but the value is incremented if it isn't.
	 *
